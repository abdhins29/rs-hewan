				...
				<table class="table table-bordered">
					...
					<tbody>
						<?php 
							...
							$no = 1;
							$qq = mysqli_query($konek, "SELECT * FROM tbl_regishewan");
						...
						<tr>
							...
							<td align="center">
								<a href="editdatapasien.php?id=<?php echo $dd['kd_pasien']; ?>"><i class="btn btn-sm btn-success"><span class="fas fa-edit"></span></i></a>
							</td>
							<td align="center">
								<a href="hapusdatapasien.php?id=<?php echo $dd['kd_pasien']; ?>"><i class="btn btn-sm btn-danger"><span class="fas fa-trash"></span></i></a>
							</td>
						</tr>
						<?php 
							}
